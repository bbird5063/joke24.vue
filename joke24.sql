...
--
-- Хост: 127.0.0.1
-- Время создания: Дек 07 2023 г., 11:10
...
(7, 16, 1, 4, '12:16:00', 'Поповнення мобільного +380686803471	\r\n', -57.57),
...
--
ALTER TABLE `day_payment`
  MODIFY `id_date_payment` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
